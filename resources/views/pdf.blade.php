    ...
    <div class="add-detail mt-10">
        <div class="w-50 float-left mt-10">
            ...
            <p class="m-0 pt-5 text-bold w-100">Order Date - <span
                    class="gray-color">{{ $order[0]->created_at }}</span></p>
            <p class="m-0 pt-5 text-bold w-100">Order Status - <span class="gray-color">{{$order[0]->status}}</span></p>
    ...
    <div class="table-section bill-tbl w-100 mt-10">
        <table class="table w-100 mt-10">
            ...
            <tr>
                <td>
                    <div class="box-text">
                        <p>5th Floor, 501 Binori Bsquare2</p>
                        <p> Nr Double Tree By Hilton</p>
                        <p>Ambli Rd</p>
                        <p>Bopal</p>
        ...
        <table class="table">
            ...
            <tbody>
                @foreach ($order as $item)
                    <td>{{ $order[0]->product->name }}</td>
                    <td>{{ $order[0]->product->description }}</td>
                    <td>{{ $order[0]->product->price }}</td>
                    </tr>
